...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  // Gold Events
  [GoldEvents.gold_entrypoint_press]: `When user taps on the Digital Gold entrypoint in TabHome`,
  [GoldEvents.gold_info_view]: `When user views the Gold info screen`,
  [GoldEvents.gold_info_learn_press]: `When user taps 'Learn More' on the gold info screen`,
  [GoldEvents.gold_info_get_started_press]: `When user taps 'Get Started' on the gold info screen`,
  [GoldEvents.gold_home_view]: `When user views the Gold home screen`,
  [GoldEvents.gold_buy_press]: `When user taps 'Buy Gold' button`,
  [GoldEvents.gold_sell_press]: `When user taps 'Sell Gold' button`,
  [GoldEvents.gold_price_alerts_press]: `When user taps to set price alerts`,
  [GoldEvents.gold_buy_start]: `When user starts the buy gold flow`,
  [GoldEvents.gold_buy_enter_amount]: `When user enters an amount in the buy flow`,
  [GoldEvents.gold_buy_quote_received]: `When a buy quote is successfully received`,
  [GoldEvents.gold_buy_confirm]: `When user confirms the buy transaction`,
  [GoldEvents.gold_buy_submit_start]: `When buy transaction submission starts`,
  [GoldEvents.gold_buy_submit_success]: `When buy transaction succeeds`,
  [GoldEvents.gold_buy_submit_error]: `When buy transaction fails`,
  [GoldEvents.gold_buy_submit_cancel]: `When user cancels buy transaction`,
  [GoldEvents.gold_sell_start]: `When user starts the sell gold flow`,
  [GoldEvents.gold_sell_enter_amount]: `When user enters an amount in the sell flow`,
  [GoldEvents.gold_sell_quote_received]: `When a sell quote is successfully received`,
  [GoldEvents.gold_sell_confirm]: `When user confirms the sell transaction`,
  [GoldEvents.gold_sell_submit_start]: `When sell transaction submission starts`,
  [GoldEvents.gold_sell_submit_success]: `When sell transaction succeeds`,
  [GoldEvents.gold_sell_submit_error]: `When sell transaction fails`,
  [GoldEvents.gold_sell_submit_cancel]: `When user cancels sell transaction`,
  [GoldEvents.gold_price_alert_create]: `When user creates a price alert`,
  [GoldEvents.gold_price_alert_delete]: `When user deletes a price alert`,
  [GoldEvents.gold_price_alert_toggle]: `When user toggles a price alert on/off`,
